...
test("rememberTrustedPhone preserves previously trusted phones", () => {
  const state = makeDeviceState({
    trustedPhones: {
      "phone-1": "phone-public-key-1",
    },
...
test("rememberTrustedPhone updates one trusted phone without dropping the others", () => {
  const state = makeDeviceState({
    trustedPhones: {
      "phone-1": "phone-public-key-1",
      "phone-2": "phone-public-key-2",
