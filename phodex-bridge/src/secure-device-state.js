...
// Persists the trusted iPhone identity so reconnects can be authenticated during later pairing flows.
function rememberTrustedPhone(state, phoneDeviceId, phoneIdentityPublicKey, { persist = true } = {}) {
  ...
  // Preserve existing trusted phones so one Mac can keep more than one device enrolled.
